...
By default, groincoind will dump mempool on shutdown and
...
class MempoolPersistTest(GroincoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give groincoind a second to reload the mempool
        ...
        self.log.debug("Prevent groincoind from writing mempool.dat to disk. Verify that `savemempool` fails")

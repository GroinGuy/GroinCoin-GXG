...
# TestNode: A peer we use to send messages to groincoind, and store responses.
...
class CompactBlocksTest(GroincoinTestFramework):
    ...
    # This test actually causes groincoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that groincoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for groincoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # groincoind will not send blocktxn responses for blocks whose height is

...
#ifndef GROINCOIN_WALLET_WALLET_H
#define GROINCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this groincoin node, and set to 0 for transactions that were created
...
#endif // GROINCOIN_WALLET_WALLET_H

/* src/config/groincoin-config.h.  Generated from groincoin-config.h.in by configure.  */
/* src/config/groincoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef GROINCOIN_CONFIG_H

#define GROINCOIN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Groincoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Groincoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/groincoin/groincoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Groincoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Groincoin Core 0.16.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "groincoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://groincoincore.org/"

...
#ifndef GROINCOIN_TEST_SCRIPTNUM10_H
#define GROINCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Groincoin Core 0.10.0, for cross-comparison.
 */
public:

...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<GroincoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_groincoin-qt -platform xcb      # Linux
//     src/qt/test/test_groincoin-qt -platform windows  # Windows
//     src/qt/test/test_groincoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = GroincoinUnits::formatWithUnit(unit, balance, false, GroincoinUnits::separatorAlways);
    ...
    // Amount input
    GroincoinAmountField* amountInput = receiveCoinsDialog.findChild<GroincoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: groincoin:")) != -1);

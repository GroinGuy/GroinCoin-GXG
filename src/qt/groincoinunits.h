...
#ifndef GROINCOIN_QT_GROINCOINUNITS_H
#define GROINCOIN_QT_GROINCOINUNITS_H
...
/** Groincoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class GroincoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit GroincoinUnits(QObject *parent);

    /** Groincoin units.
      @note Source: https://en.groincoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        GXG,
...
typedef GroincoinUnits::Unit GroincoinUnit;

#endif // GROINCOIN_QT_GROINCOINUNITS_H

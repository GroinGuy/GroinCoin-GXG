...
* groincoin.conf: contains configuration settings for groincoind or groincoin-qt
* groincoind.pid: stores the process id of groincoind while running
...
* debug.log: contains debug information and general logging generated by groincoind or groincoin-qt

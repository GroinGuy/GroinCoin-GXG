...
This document provides guidelines for internationalization of the Groincoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `groincoin_en.ts` remains unchanged.

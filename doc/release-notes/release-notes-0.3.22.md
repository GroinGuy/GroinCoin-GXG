Download URL: https://sourceforge.net/projects/groincoin/files/Groincoin/groincoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 GXG fee schedule (users still pay 0.01 GXG per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #groincoin00 - #groincoin99

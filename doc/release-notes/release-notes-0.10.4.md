Groincoin Core version 0.10.4 is now available from:

  <https://groincoin.org/bin/groincoin-core-0.10.4/>
...
- #6953 `43c2789` Split groincoin-tx into its own package
- #6953 `dfe0d4d` Include groincoin-tx binary on Debian/Ubuntu

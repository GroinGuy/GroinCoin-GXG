Groincoin Core version 0.13.2 is now available from:

  <https://groincoin.org/bin/groincoin-core-0.13.2/>
...
- #8908 `4a974b2` Update groincoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow groincoin-tx to create v2 transactions (gxgdrak)

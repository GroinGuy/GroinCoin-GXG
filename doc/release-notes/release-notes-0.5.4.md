Groincoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/groincoin/files/Groincoin/groincoin-0.5.4/
...
http://gitorious.org/groincoin/groincoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Groincoin-Qt notifications under Growl 1.3.
Increase required age of Groincoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxGroincoin properly when installing Groincoin-Qt over it. (Windows)

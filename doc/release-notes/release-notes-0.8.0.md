Groincoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/groincoin/files/Groincoin/groincoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Groincoin
...
New/changed settings (command-line or groincoin.conf file)
--------------------------------------------------------

Groincoin Core version 0.9.4 is now available from:

  https://groincoin.org/bin/0.9.4/
...
this update is incompatible with the Groincoin system and could lead to consensus
forks.

Groincoin Core released binaries from https://groincoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~groincoin/+archive/ubuntu/groincoin
- A third-party or self-compiled Groincoin Core

upgrade to Groincoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.

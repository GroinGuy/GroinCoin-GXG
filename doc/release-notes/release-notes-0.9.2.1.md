Groincoin Core version 0.9.2.1 is now available from:

  https://groincoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 GXG to 0.01 GXG
...
- Fix "Start groincoin on system login"
